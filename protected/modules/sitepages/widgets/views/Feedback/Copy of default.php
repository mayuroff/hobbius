<?php
{
			...
			if (isset($_POST['filform'])) {
				...
				if ($error != 0) {
					...
					$to2 = 'brainstorm@delfbrick.ru';
					$to3 = 'brainstorm@delfbrick.ru';
					
					$headers = "From: Delfbrick.Ru <otvetanet@delfbrick.ru>\n";
					...
					<h3>Новое сообщение в обратной связи Delfbrick.RU</h3>";
