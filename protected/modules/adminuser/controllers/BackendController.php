...
class BackendController extends ModuleAdminController
{
	...
	public function accessRules()
	{
		...
		/*
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('index','create','update','del'),
				'roles'=>array('role_users'),
				'users'=>array('@'),
			),
			/*
	...
	*/
	...
	{
		$dataProvider=new CActiveDataProvider('Usersadmin');
...
*/
	 ...
	 * @param Usersadmin $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='usersadmin-form')
		{
