...
class ErrorView_Standard extends ErrorView {
	public function applyAjaxErrorResponse() {
		...
		var errorHTML = '<div class="alert alert-error"><a class="close" data-dismiss="alert" href="#">Г—</a><strong class="alert-heading">The following ' + errorFormat + ' found:</strong><ul>';
    ...
    public function render() {
        ...
        if(!empty($errors)) {
			...
			<div class="alert alert-error">
				...
				<strong class="alert-heading">Исправьте следующие <!--$format--> ошибки:</strong>
				<ul><li>$errors</li></ul>
			</div>
HTML;
        }
