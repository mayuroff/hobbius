...
JS;
	...
	public static function isStaticValid($id) {
		if (isset($_SESSION["pfbc"][$id]["errors"])) {
			if (!is_array($_SESSION["pfbc"][$id]["errors"])) return true;
			foreach ($_SESSION["pfbc"][$id]["errors"] AS $key => $val){
